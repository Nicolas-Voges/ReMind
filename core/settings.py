...
USE_EMAIL_FILE_BACKEND = (
    os.environ.get("USE_EMAIL_FILE_BACKEND", default="False") == "True"
)
USE_EMAIL_CONSOLE_BACKEND = (
    os.environ.get("USE_EMAIL_CONSOLE_BACKEND", default="False") == "True"
)
