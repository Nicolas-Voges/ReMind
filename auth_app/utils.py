    ...
    match content_type:
        ...
        case 'reset_password':
            ...
            text_content = render_to_string(
                ...
                {
                    "user": instance,
                    "reset_link": f"{frontend_url}/pages/auth/confirm_password.html?uid={uidb64}&token={token}",
                },
            )
            html_content = render_to_string(
                f"emails/{content_type}.html",
...
def send_mail(uidb64, token, instance, content_type):
    ...
    subject, text_content, html_content = get_content(
        uidb64, token, instance, content_type
    )
